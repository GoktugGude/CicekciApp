...
const items = document.querySelectorAll("body,.navbar-wrapper,.navbar-wrapper a,.logo-wrapper,.logo-wrapper img,.slogan-text p,.toggle-ball,.all-products,p,.card-picture img");
